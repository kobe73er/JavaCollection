...
public class Histogram extends JPanel {
	...
	public void showHistogram(int[] numCount,String[] wordCount ) {
		this.count = numCount;
	...
	protected void paintComponent(Graphics g) {
		...
		int interval = (width - 100) / count.length;
		int individualWidth = (int) (((width - 10) / count.length) * 0.80);
		...
		for (int i = 0; i < count.length; i++) {
			...
			g.drawString(wordCount[i]+"", x, height - 30);
